...
double Pa[300], Pn[300];
double Ma[300][300], Mn[300][300];
double Na[300][300], Nn[300][300];
double Y_paa[300][300], Y_pan[300][300];
double Y_pra[300][300], Y_prn[300][300];
double V_paa[300][300], V_pan[300][300];
double V_pra[300][300], V_prn[300][300];
double Phi_a, Phi_n;
double PAS_a[500], PAS_n[500];
double PAS_amax, PAS_nmax;
double PAS_amin, PAS_nmin;
double dot, eucl;
double consmatrx_Paa[300][300], consmatrx_Pra[300][300];
double consmatrx_Pcaa[300][300], consmatrx_Pcra[300][300];

double consmatrx_Pan[300][300], consmatrx_Prn[300][300];
double consmatrx_Pcan[300][300], consmatrx_Pcrn[300][300];

/*Declaration for input of Current*/
double Mca[300][300], Mcn[300][300];
double Nca[300][300], Ncn[300][300];
double Yc_paa[300][300], Yc_pan[300][300];
double Yc_pra[300][300], Yc_prn[300][300];
double Vc_paa[300][300], Vc_pan[300][300];
double Vc_pra[300][300], Vc_prn[300][300];
double Phic_a, Phic_n;
double PASc_a[500], PASc_n[500];

// declare for D parameter
double cur_a[300], cur_b[300], cur_c[300], cur_n[300];

// declare for other elementary
double S1[300][300], S2[300][300];
double mid1[300][300];
double mid2[300][300];
double c1[300][300];

double determinant(double [][40], double);

void cofactor(double [][40], double);

void transpose(double [][40], double [][40], double);
...
// Multiply two matrix
void MatrixMultiply(double a[][300], double b[][300], int row1, int col1, int col2, double c[][300])
{
...
double DotProduct(double a[][300], double b[][300], int k)
{
	double c = 0;
	for (int i = 0; i < k; i++)
	{
...
double Euclidian(double a[][300], double b[][300], int k)
{
	int i;
	double c = 0;
	double d = 0;
    ...
    double determinant(double a[40][40], double index)
    {
...
int main(void)
{
	...
	volatile int sampledouble = 301;

	volatile Signal S[301];
	...
	while (count < 300)
	{
		...
		else
		{
			...
			for (i = 0; i < sample; i++)
			{
				...
				//Mca[i][0] = cur_a[i - alpha];
				//Mcn[i][0] = cur_n[i - alpha];
	...
	fp = fopen("PAS_data_output_2_col.txt", "w+");
